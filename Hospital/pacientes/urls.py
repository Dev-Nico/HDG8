...
urlpatterns=[
	...
	re_path(r'^pacientesEnRuta/(?P<pk>\d+)/$',views.PacientesEnRuta.as_view(), name="pacientes en ruta"),
	re_path(r'^paciente/(?P<rut>[0-9]{8}[0-9k]{1})/$',views.DetallePacienteView.as_view(), name="detalle paciente"),
	re_path(r'^ruta/paciente/(?P<rut>[0-9]{8}[0-9k]{1})/$',views.DetallePacienteView2.as_view(), name=" detalle paciente 2"),
	re_path(r'^ruta/(?P<pk>\d+)/$',views.DetalleRutaView.as_view(), name="detalle ruta"),
